...
kind, profile, offset and limit. `/v1/profiles`, `/v1/manifests/{digest}`,
...
manifests, schemas, standalone recipe exports, and `index.html`. Third-party manifests enter through reviewed files in
